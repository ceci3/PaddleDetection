...
#        self.bbox_eval()
    ...
    def bbox_eval(self):
        ...
        for iter_id, image_path in enumerate(imid2path):
            image_path = os.path.join(self.img_root_dir, image_path)
        ...
        if self.eval_mode == 'python':
            ...
            ap = calculate_ap_py(pred_res_file, self.anno_file, self.pred_dir)
